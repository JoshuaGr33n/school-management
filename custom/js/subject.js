...
function getClassSection(classId = null) 
{
	if(classId) {
		...
		$.ajax({
			url: base_url + 'index.php/subject/fetchSubjectTable/' + classId,
			type: 'post',		
			...
			$.ajax({
				...
				success:function(response) {
					if(response.success == true) {					
						...
						$("#manageSubjectTable").load(base_url + 'index.php/subject/fetchUpdateSubjectTable/' + classId);
...
function editSubject(subjectId = null, classId = null)
{
	if(subjectId && classId) {
		...
		$.ajax({
			url: base_url + 'index.php/subject/fetchSubjectByClassSection/'+classId+'/'+subjectId,
			type: 'post',
			dataType: 'json',
			success:function(response) {
					...
					$.ajax({
						...
						success:function(response) {
							if(response.success == true) {
								...
								$("#manageSubjectTable").load('index.php/subject/fetchUpdateSubjectTable/' + classId);
...
function removeSubject(subjectId = null, classId = null) 
{
	if(subjectId && classId) {
		...
		$("#removeSubjectBtn").unbind('click').bind('click', function() {
			$.ajax({
				url: base_url + 'index.php/subject/remove/'+subjectId,
				type: 'post',
				dataType: 'json',
				success:function(response) {
					if(response.success === true) {
