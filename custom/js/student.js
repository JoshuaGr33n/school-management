...
$(document).ready(function() {
	...
	if(request == 'addst') {
		...
		$("#className").unbind('change').bind('change', function() {
			...
			$("#sectionName").load(base_url + 'index.php/student/fetchClassSection/'+class_id);
		});
...
function getClassSection(classId = null) 
{
	if(classId) {
		...
		$.ajax({
			url: base_url + 'index.php/student/getClassSectionTab/'+classId,
			type: 'post',
			dataType: 'json',
			success:function(response) {
...
function updateStudent(studentId = null)
{
	if(studentId) {
		...
		$.ajax({
			url: base_url + 'index.php/student/fetchStudentData/'+studentId,
			type: 'post',
			dataType: 'json',
			success:function(response){
				...
				$("#editSectionName").load('index.php/student/fetchClassSection/'+response.class_id, function(i) {
				...
				$("#editClassName").unbind('change').bind('change', function() {
					var class_id = $(this).val();
					$("#editSectionName").load('index.php/student/fetchClassSection/'+class_id);
				});
					...
					$.ajax({
						...
						success:function(response) {					
							...
							if(response.success == true) {						
								...
								$.ajax({
									url: 'index.php/student/fetchStudentData/'+studentId,
									type: 'post',
									dataType: 'json',
									success:function(response) {
...
function removeStudent(studentId = null)
{
	if(studentId) {
		$("#removeStudentBtn").unbind('click').bind('click', function() {
			$.ajax({
				url: 'index.php/student/remove/'+studentId,
				type: 'post',
				dataType: 'json',
				success:function(response) {
					if(response.success == true) {
...
function addRow()
{
	...
	$.ajax({
		url: base_url + 'index.php/student/getAppendBulkStudentRow/'+countId,
		type: 'post',
		success:function(response) {				
...
function getSelectClassSection(rowId = null)
{
	if(rowId) {
		...
		$("#bulkstsectionName" + rowId).load(base_url + 'index.php/student/fetchClassSection/'+class_id);
	}
}