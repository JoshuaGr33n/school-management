...
$(document).ready(function() {
	...
	manageTeacherTable = $("#manageTeacherTable").DataTable({
		'ajax' : base_url + 'index.php/teacher/fetchTeacherData',
		'order' : []
	});
...
function editTeacher(teacherId = null)
{
	if(teacherId) {
		...
		$.ajax({
			url: base_url + 'index.php/teacher/fetchTeacherData/'+teacherId,
			type: 'post',
			dataType: 'json',
			success:function(response){
...
function removeTeacher(teacherId = null)
{
	if(teacherId) {
		$("#removeTeacherBtn").unbind('click').bind('click', function() {
			$.ajax({
				url : base_url + 'index.php/teacher/remove/'+teacherId,
				type: 'post',
				dataType: 'json',
				success:function(response) {
					if(response.success == true) {
