...
function getClassSection(classId = null) 
{
	if(classId) {
		...
		$.ajax({
			url: base_url + 'index.php/section/fetchSectionTable/' + classId,
			type: 'post',		
			...
			$.ajax({
				...
				success:function(response) {
					if(response.success == true) {					
						...
						$("#manageSectionTable").load(base_url + 'index.php/section/fetchUpdateSectionTable/' + classId);
...
function editSection(sectionId = null, classId = null)
{
	if(sectionId && classId) {
		...
		$.ajax({
			url: base_url + 'index.php/section/fetchSectionByClassSection/'+classId+'/'+sectionId,
			type: 'post',
			dataType: 'json',
			success:function(response) {
...
function removeSection(sectionId = null, classId = null) 
{
	if(sectionId && classId) {
		...
		$("#removeSectionBtn").unbind('click').bind('click', function() {
			$.ajax({
				url: base_url + 'index.php/section/remove/'+sectionId,
				type: 'post',
				dataType: 'json',
				success:function(response) {
					if(response.success === true) {
